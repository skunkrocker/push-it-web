...
internal class UploadCertificateControllerTest {
    ...
    fun `upload certificate for app name with success`() {
        ...
        val myKeyStore =
            MockMultipartFile("p12", certificateFile.filename!!, "application/x-pkcs12", certificateFile.inputStream)
        ...
        val bodyResponse =
            objectMapper.readValue(result.response.contentAsString, CertificateUploadApiResponse::class.java)
    ...
    private fun mockHttpServletRequestBuilder(
        myKeyStore: MockMultipartFile,
        token: String,
        appName: String,
        password: String
